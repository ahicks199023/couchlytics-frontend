                      ...
                      teamData.mostExpensive.slice(0, 10).map((player, index) => (
                        <tr key={index} className="border-b border-gray-700/50">
                          <td className="py-1 px-1 text-white text-xs">
                            {player.maddenId || player.madden_id || player.playerId || player.id ? (
                              <Link 
                                href={`/leagues/${leagueIdString}/players/${player.maddenId || player.madden_id || player.playerId || player.id}`}
